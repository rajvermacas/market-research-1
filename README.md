...
| Floor-lift fresh-print book + weak-month book cap + 3-month hold (`strat_floorhightiershapeconc`, cap_weak 11 / max_hold 3 / tier 0.9999) | 2015→2026, monthly, full NSE board, top 15 | Train +85.2% CAGR at −17.5% DD (calmar 4.87) vs equal-weight +19.8%/−62.7%; forward +53.8% (fwd DD −14.4% vs bench −27.9%); full-window DD −25.8% | **Best line in the research ledger so far, but nse_all-tuned.** Doesn't transfer to index universes (Nifty 500 +39.5%/−26.6%, fwd DD −30.4% worse than bench) and the full board carries severe survivorship bias — a lead, not a validated strategy. Lineage: tiershape (Loop-10) → weak-month cap + short hold (Loop-12); forward-preserving alternatives at +57.3% (cap_full 15/max_hold 8) and +58.9% (max_hold 6) are recorded in the ledger. Ledger: `.cache/strategy_lab/results.tsv` |
