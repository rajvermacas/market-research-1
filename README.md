...
| Floor-lift fresh-print book + shaped exposure + freshness premium (`strat_floorhighrankpersist`, pers_lb 6 / pers_w −0.16 / max_hold 4) | 2015→2026, monthly, full NSE board, top 15 | Train +83.9% CAGR at −20.0% DD (calmar 4.20) vs equal-weight +19.8%/−62.7%; forward +49.9% (fwd DD −16.4% vs bench −27.9%); full-window DD −22.7% | **Best line in the research ledger so far, but nse_all-tuned.** Doesn't transfer to index universes (Nifty 500 +43.8%/−20.6%, midcap150 +17.9%/−37.7%, nifty100 +15.1%/−33.9%) and the full board carries severe survivorship bias — a lead, not a validated strategy. Lineage: `strat_floorhightiershape` (Loop-10) → freshness-premium weighting + 4-month hold (Loop-11). Ledger: `.cache/strategy_lab/results.tsv` |
