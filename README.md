...
| Floor-lift fresh-print book, shaped exposure + print-continuity (`strat_floorhightiershape`) | 2015→2026, monthly, full NSE board, top 15 | Train +77.9% CAGR at −19.0% DD (calmar 4.10) vs equal-weight +19.8%/−62.7%; forward +50.0% vs bench +14.7% | **Best line in the research ledger so far, but nse_all-tuned.** Doesn't transfer to index universes (Nifty 500 +41.9%/−25.3%, midcap150 +17.9%/−37.7%, nifty100 +15.1%/−33.9%) and the full board carries severe survivorship bias — a lead, not a validated strategy. Ledger: `.cache/strategy_lab/results.tsv` |
